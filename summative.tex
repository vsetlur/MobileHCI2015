...
Results in fact exceeded our expectations, with \textit{GraphTiles} users almost twice as fast as IMDb web app users. It should be said that \textit{GraphTiles} was designed specifically for imprecise queries; IMDb is a more general tool. What remains to be seen is whether or not a single interface can support both precise and imprecise queries well.
