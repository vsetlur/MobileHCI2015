...
On reflection, it is not surprising that search difficulty was prevalent in imprecise or general task types: they are simply more complex. We believe the large majority of problem searches could have benefited from a tool that helped users navigate through the complex information neighborhoods typical of imprecise and general search, and that a good starting point for such a tool would be exploiting the structure available in many datasets. 
